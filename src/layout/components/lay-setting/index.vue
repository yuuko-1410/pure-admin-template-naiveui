    ...
    <div class="p-5">
      ...
      <ul class="setting">
        <li>
          ...
          <n-switch
            v-model:value="settings.greyVal"
            size="small"
            @update:value="greyChange"
          >
        ...
        <li>
          ...
          <n-switch
            v-model:value="settings.weakVal"
            size="small"
            @update:value="weekChange"
          >
            <template #checked> 开 </template>
            <template #unchecked> 关 </template>
          </n-switch>
        ...
        <li>
          ...
          <n-switch
            v-model:value="settings.tabsVal"
            size="small"
            @update:value="tagsChange"
          >
            <template #checked> 开 </template>
            <template #unchecked> 关 </template>
          </n-switch>
        ...
        <li>
          ...
          <n-switch
            v-model:value="settings.hideFooter"
            size="small"
            @update:value="hideFooterChange"
          >
            <template #checked> 开 </template>
            <template #unchecked> 关 </template>
          </n-switch>
        ...
        <li>
          ...
          <n-switch
            v-model:value="logoVal"
            size="small"
            @update:value="logoChange"
          >
            <template #checked> 开 </template>
            <template #unchecked> 关 </template>
          </n-switch>
        ...
        <li>
          ...
          <n-switch
            v-model:value="settings.multiTagsCache"
            size="small"
            @update:value="multiTagsCacheChange"
          >
            <template #checked> 开 </template>
            <template #unchecked> 关 </template>
          </n-switch>
